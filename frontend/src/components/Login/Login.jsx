      ...
      <div className="bg-darkGreenForBG shadow-lg rounded-lg overflow-hidden w-full max-w-4xl flex">
        <div className="w-full md:w-1/2 p-8 order-2">
          ...
          <form onSubmit={handleLogin}>
            ...
            <div className="mb-4 relative">
              ...
              >
                {showPassword ? <FaEyeSlash className="mt-6 text-white" /> : <FaEye className="mt-6 text-white" />}
              </div>
            </div>
            {error && <p className="text-red-500 mt-2">{error}</p>}
            <div className="flex justify-center">
              <button type="submit" className="bg-yellowishGreenForTextandButtons hover:bg-white text-darkGreenForText px-8 py-3 rounded-full mt-4 font-semibold">Login</button  > 
            </div>
          </form>
        ...
        <div className="w-full md:w-1/2 p-8 flex flex-col items-center justify-center order-1 bg-transparent/10">
          <div className="text-center mb-4">
            ...
            <span
              className="w-full bg-yellowishGreenForTextandButtons hover:bg-white text-darkGreenForText px-8 py-3 rounded-full mt-4 cursor-pointer font-semibold"
              onClick={() => {
                resetInputs();
                navigate("/register");
              }}
